...
<<<<<<< Updated upstream:Assets/Script/Units/Builder.cs
...
=======
    ...
    private Unit unit;
>>>>>>> Stashed changes:Assets/Scripts/Unit/Builder.cs
...
>>>>>>> Stashed changes:Assets/Scripts/Unit/Builder.cs
    ...
    private void BuildProgress()
    {
        ...
        if ((b.CurHP >= b.MaxHP) && b.InFunctional)
        {
        ...
        if (b.Timer >= b.WaitTime)
        {
            ...
            if (b.InFunctional == false) //if this building is being built, not being fixed
